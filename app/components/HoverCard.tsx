...
const Card: React.FC<CardType> = ({ title, subtitle, Icon, href }) => {
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-r from-amber-400 to-yellow-500 translate-y-[100%] group-hover:translate-y-[0%] transition-transform duration-300" />
