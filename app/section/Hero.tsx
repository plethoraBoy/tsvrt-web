  ...
  return (
    <section id="hero" className="bg-neutral-950 ">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[yellow] to-[#929258] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-4xl py-32 sm:py-56 lg:py-56">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-white-900 sm:text-6xl">
              Welcome to The SkyView Roof Multicuisine Restaurant{" "}
            </h1>
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#menu"
                className="rounded-full ring-2 ring-yellow-500 ring-inset px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-yellow-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-600"
              >
                Our Menu
              </a>
              <a
